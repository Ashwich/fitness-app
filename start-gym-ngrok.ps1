# Start ngrok tunnel for gym-management-service (port 3000)
...
Write-Host "Checking if gym-service is running on port 3000..." -ForegroundColor Yellow
$portCheck = netstat -ano | findstr :3000
if (-not $portCheck) {
    Write-Host "⚠️  WARNING: Nothing is running on port 3000!" -ForegroundColor Red
